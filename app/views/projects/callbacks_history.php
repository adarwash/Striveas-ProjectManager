	...
	<div class="rounded-3 p-4 mb-4 client-header-solid">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item"><a href="/projects/viewProject/<?= (int)$project->id ?>" class="text-decoration-none"><?= htmlspecialchars($project->title) ?></a></li>
				<li class="breadcrumb-item active" aria-current="page">Callbacks History</li>
			</ol>
		</nav>
		<div class="d-flex justify-content-between align-items-center">
			<div>
				<h1 class="h3 mb-1 text-dark">Follow-ups History</h1>
				<p class="text-muted mb-0">Completed and missed reminders for this project</p>
			</div>
			<div class="d-flex gap-2">
				<a href="/projects/viewProject/<?= (int)$project->id ?>" class="btn btn-outline-secondary">
	...
	<div class="card border-0 shadow-sm">
		...
		<div class="card-body">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-end">
								...
								<?php endif; ?>
								<form action="/projects/deleteCallback/<?= (int)$cb['id'] ?>" method="post" class="d-inline" onsubmit="return confirm('Delete this follow-up?');">
			...
			<div class="text-center py-4">
				...
				<h6 class="text-muted mt-2 mb-0">No callbacks found</h6>
			</div>
			<?php endif; ?>
		</div>
	</div>
