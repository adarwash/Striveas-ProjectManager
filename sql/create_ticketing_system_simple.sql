-- Simplified Ticketing System Database Schema
...
-- Create Ticket Categories lookup table (without foreign keys first)
...
CREATE TABLE dbo.Tickets (
    id INT IDENTITY(1,1) PRIMARY KEY,
    ticket_number NVARCHAR(20) NULL, -- Will be auto-generated
...
-- Add self-referencing constraints for TicketCategories
...
PRINT 'Simplified ticketing system database schema created successfully!';